...
import static WeatherUpdateService.Constants.month;
import static WeatherUpdateService.Constants.strDays;
...
public class TimeFormatter {
   ...
   static public String getSDFtime(long arrival_time_millis,String timezoneid){
    ...
    static public long getTime_Now(){
        final Calendar c = Calendar.getInstance();
        return c.getTimeInMillis();
    }

    static public String getTimeZoneID(){
        final Calendar c = Calendar.getInstance();
        return c.getTimeZone().getID();
    }
}
